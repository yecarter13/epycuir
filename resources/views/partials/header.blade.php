        ...
        <div class="flex items-center justify-between h-14 lg:h-20">
            ...
            <div class="flex items-center gap-1 sm:gap-2 shrink-0 min-w-0">
                <a href="{{ route('home') }}" class="flex items-center gap-1.5 sm:gap-2.5 group">
                    ...
                    <span class="text-sm sm:text-lg md:text-xl font-bold text-white tracking-tight whitespace-nowrap">Sellerie<span class="text-safety"> Super Confort</span></span>
                </a>
            ...
            <div class="flex items-center gap-0.5 sm:gap-2">
                ...
                <button id="mobile-menu-toggle" class="lg:hidden p-2 text-stable-300 hover:text-white hover:bg-stable-800 rounded-lg transition-all duration-200" title="Menu">
