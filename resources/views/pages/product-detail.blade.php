...
@section('title', $product->name . ' — Pinault Sellerie')
...
$ldProduct = [
    ...
    'offers' => [
        ...
        'seller' => ['@type' => 'Organization', 'name' => 'Pinault Sellerie'],
    ],
];
            ...
            <div class="mt-8 lg:mt-0">
                ...
                <div class="mt-8 space-y-3">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        <a id="waCommanderBtn" href="#" target="_blank" rel="noopener" class="flex-1 px-8 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg flex items-center justify-center gap-2">
...
<script>
    ...
    if (waCommanderBtn) {
        ...
        waCommanderBtn.addEventListener('click', function(e) {
            ...
            const msg = 'Bonjour Pinault Sellerie, je souhaite commander cet article :\n\n'
