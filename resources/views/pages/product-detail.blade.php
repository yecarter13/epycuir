            ...
            <div class="mt-8 lg:mt-0">
                ...
                <div class="mt-6">
                    <div class="flex items-baseline gap-3">
                        ...
                        <span class="px-2.5 py-1 bg-green-50 text-green-600 text-xs font-bold rounded-lg">Économisez &euro;{{ number_format($product->old_price - $product->price, 2) }}</span>
                        @endif
                    </div>
                ...
                <div class="mt-4 flex items-center gap-2">
                    ...
                    <span class="text-sm text-green-600 font-medium">En stock — prêt à expédier</span>
