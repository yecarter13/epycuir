...
@section('title', 'Confidentialité — Pinault Sellerie')
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl border border-stable-100 p-8 lg:p-10 space-y-8">
            <div>
                ...
                <p class="text-stable-600 leading-relaxed">Pinault Sellerie est une boutique d'équipement équestre située au 25 rue de Cogiandant Crénière, 10270 Courteranges, en France. Cette politique de confidentialité explique comment nous collectons, utilisons et protégeons vos données personnelles lorsque vous utilisez notre site web et nos services.</p>
            </div>
            <div>
