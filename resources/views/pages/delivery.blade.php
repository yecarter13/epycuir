        ...
        <div class="bg-white rounded-2xl border border-stable-100 p-8 lg:p-10 space-y-8">
            ...
            <div>
                ...
                <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4 flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-green-800">Livraison offerte dès 80 &euro;</p>
                        <p class="text-xs text-green-600">La livraison standard est offerte pour toute commande de 80 &euro; ou plus. Aucun code requis — la réduction est appliquée automatiquement au moment du paiement.</p>
                    </div>
                </div>
                <div class="space-y-3 text-stable-600">
                    ...
                    <div class="flex justify-between items-center py-2"><span class="font-medium text-green-700">Livraison offerte</span><span class="font-semibold text-green-700">Commandes dès 80 &euro;</span></div>
                </div>
            </div>
            <div>
