...
@section('title', 'À propos — Pinault Sellerie')
...
<section class="relative bg-stable-900 py-20 lg:py-28 overflow-hidden">
    <div class="absolute inset-0">
        <img src="https://images.unsplash.com/photo-1553284965-83fd3e82fa5a?w=1920&q=80" alt="Atelier Pinault Sellerie" class="w-full h-full object-cover" loading="lazy">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-lg text-stable-200 max-w-2xl mx-auto">Depuis plus de 15 ans, Pinault Sellerie est la référence française du matériel équestre : selles, brides, tapis, licols et accessoires d'écurie.</p>
    </div>
</section>
