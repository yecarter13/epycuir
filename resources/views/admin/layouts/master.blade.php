...
<head>
    ...
    <title>@yield('title', 'Admin — Pinault Sellerie')</title>
            ...
            <div class="p-5 border-b border-stable-700">
                <div class="flex items-center justify-between">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2.5">
                        ...
                        <span class="text-lg font-bold text-white whitespace-nowrap">Pinault <span class="text-safety">Sellerie</span> <span class="text-xs text-stable-400 font-normal">Admin</span></span>
                    </a>
