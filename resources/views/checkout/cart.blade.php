...
@section('title', 'Panier — Pinault Sellerie')
        ...
        <div class="lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div class="mt-8 lg:mt-0">
                <div class="bg-white rounded-xl border border-stable-100 p-6 sticky top-28">
                    ...
                    @if($waCartUrl)
                    <a href="{{ $waCartUrl }}" target="_blank" rel="noopener" class="mt-6 w-full px-6 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-blue-600/25">
