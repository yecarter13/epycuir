...
<head>
    ...
    <title>Connexion admin — Pinault Sellerie</title>
    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            <a href="{{ route('home') }}" class="inline-flex items-center gap-2.5 text-white hover:text-safety transition-colors">
                ...
                <span class="text-xl font-bold">Pinault Sellerie <span class="text-safety font-light">France</span></span>
            </a>
        </div>
        ...
        <p class="text-center mt-8 text-stable-400 text-xs">
            &copy; {{ date('Y') }} Pinault Sellerie. Tous droits réservés.
        </p>
    </div>
</body>
</html>
